...
const dispatcherMenu = [
  { icon: 'LayoutDashboard', label: 'Dashboard', href: '/dashboard-dispatcher' },
  { icon: 'Activity', label: 'Trips', href: '/dashboard-dispatcher/trips' },
  { icon: 'Truck', label: 'Vehicles', href: '/dashboard-dispatcher/vehicles' },
